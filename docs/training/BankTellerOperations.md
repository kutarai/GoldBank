# UniBank Branch Operations — Training Manual

**Audience:** Tellers, Vault Managers, Branch Managers
**System:** UniBank Bank-Teller Application (`bank-teller`)
...
This is the operational handbook for the UniBank branch counter. Every workflow is broken into:
...
The bank-teller app runs in a browser. Open it at **http://branch.unibank.local:5174** (the exact URL is on the sticker on your monitor).
...
```
+----------------------------------------------------------------------------+
| UniBank Teller   [Customers] [Drawer] [Vault*]      Drawer Open  J. Doe   |
|                                                                  Borrowdale|
|                                                       [Logout]            |
+----------------------------------------------------------------------------+
...
1. Go to the **Dashboard** (click the UniBank Teller logo top left).
...
```
================================================================================
            UNIBANK — END OF DAY TELLER REPORT
================================================================================
Branch:        Borrowdale Branch
Teller:        J. Doe
...
```
+----------------------------------------------------------------------------+
|  UNIBANK TELLER QUICK REFERENCE                                            |
|                                                                            |
...
The following sample reports were generated by the **live UniBank gateway** against the development database and reflect the exact format you'll see in production. Each was produced by a real API call inside a real drawer session.
...
For amendments, contact: branch.operations@unibank.local
