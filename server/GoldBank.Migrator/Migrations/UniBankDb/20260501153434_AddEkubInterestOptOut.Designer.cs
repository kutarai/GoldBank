...
namespace GoldBank.Migrator.Migrations.UniBankDb
{
    ...
    [Migration("20260501153434_AddEkubInterestOptOut")]
    partial class AddEkubInterestOptOut
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoldBank.Core.Modules.Ekub.Domain.Entities.EkubGroup", b =>
                {
                    ...
                    b.Property<bool>("ApplyInterestOnContributions")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
            ...
            modelBuilder.Entity("GoldBank.Core.Modules.Ekub.Domain.Entities.EkubLoan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("BorrowerCustomerId")
                        .HasColumnType("uuid")
                        .HasColumnName("borrower_customer_id");
                    ...
                    b.Property<Guid?>("TreasurerCustomerId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("BorrowerCustomerId")
                        .HasDatabaseName("ix_ekub_loans_borrower");

                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_ekub_loans_group");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_ekub_loans_status");

                    b.ToTable("ekub_loans", "bank");
                });

            modelBuilder.Entity("GoldBank.Core.Modules.Ekub.Domain.Entities.EkubLoanRepayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_ekub_loan_repayments_group");

                    b.HasIndex("LoanId")
                        .HasDatabaseName("ix_ekub_loan_repayments_loan");

                    b.ToTable("ekub_loan_repayments", "bank");
                });

            modelBuilder.Entity("GoldBank.Core.Modules.Ekub.Domain.Entities.EkubLoanVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("VoterCustomerId")
                        .HasColumnType("uuid")
                        .HasColumnName("voter_customer_id");

                    b.HasKey("Id");

                    b.HasIndex("LoanId", "VoterCustomerId")
                        .IsUnique()
                        .HasDatabaseName("ix_ekub_loan_votes_loan_voter_unique");

                    b.ToTable("ekub_loan_votes", "bank");
                });
            ...
            modelBuilder.Entity("GoldBank.Core.Modules.Ekub.Domain.Entities.EkubLoanRepayment", b =>
                {
                    b.HasOne("GoldBank.Core.Modules.Ekub.Domain.Entities.EkubLoan", "Loan")
                        .WithMany("Repayments")
