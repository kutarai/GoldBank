...
using UniBank.Core.Modules.BranchCash.Application.Services;
...
public class TellerApiController : ControllerBase
{
    ...
    private readonly UniBank.Core.Modules.BranchCash.Application.Services.VaultStockService _vaultStock;
    private readonly UniBank.Gateway.Services.VaultReportPdfService _vaultReportPdf;
    ...
    public TellerApiController(
        ...
        UniBank.Core.Modules.BranchCash.Application.Services.VaultStockService vaultStock,
        UniBank.Gateway.Services.VaultReportPdfService vaultReportPdf,
    ...
    public async Task<IActionResult> PostVaultMovement(Guid vaultId, [FromBody] VaultMovementRequest req)
    {
        ...
        try
        {
            var movement = new UniBank.Core.Modules.BranchCash.Domain.Entities.VaultMovement
            {
                VaultId = vaultId,
                Type = req.Type,
    ...
    public async Task<IActionResult> PostSpotCheck(Guid vaultId, [FromBody] SpotCheckRequest req)
    {
        ...
        try
        {
            ...
            var spot = new UniBank.Core.Modules.BranchCash.Domain.Entities.VaultSpotCheck
            {
                VaultId = vaultId,
                PerformedBy = TellerId,
                WitnessId = req.WitnessId,
