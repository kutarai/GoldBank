...
using UniBank.Core.Modules.Transfers.Domain.Events;
using UniBank.Core.Modules.Transfers.Infrastructure.Services;
using UniBank.SharedKernel.Events;
using UniBank.SharedKernel.Messaging;
using UniBank.SharedKernel.Results;

namespace UniBank.Core.Modules.Transfers.Application.Handlers;
