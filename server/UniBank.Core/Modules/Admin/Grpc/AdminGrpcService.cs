...
using UniBank.Core.Modules.Admin.Application.Handlers;
using UniBank.Core.Modules.Admin.Domain.Entities;
using UniBank.Core.Modules.FraudDetection.Application.Handlers;
using UniBank.Protos.Admin;
using UniBank.Protos.Common;
using ProtoFraudAlertSummary = UniBank.Protos.Admin.FraudAlertSummary;

namespace UniBank.Core.Modules.Admin.Grpc;
