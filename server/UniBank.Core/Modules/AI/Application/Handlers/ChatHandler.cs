...
public sealed class ChatHandler
{
    ...
    private const string SystemPrompt =
        "You are UniBank's banking assistant. You help customers with account enquiries, " +
    ...
    public ChatHandler(UniBankDbContext dbContext, OllamaClient ollamaClient, ILogger<ChatHandler> logger)
    {
