...
using GoldBank.Core.Modules.Accounts.Infrastructure.Persistence;
using GoldBank.Core.Modules.Agents.Domain.Entities;
using GoldBank.Core.Modules.Agents.Infrastructure.Persistence;
using GoldBank.Core.Modules.BillPay.Domain.Entities;
using GoldBank.Core.Modules.BillPay.Infrastructure.Persistence;
using GoldBank.Core.Modules.KYC.Domain.Entities;
using GoldBank.Core.Modules.KYC.Infrastructure.Persistence;
using GoldBank.Core.Modules.Merchants.Domain.Entities;
using GoldBank.Core.Modules.Merchants.Infrastructure.Persistence;
using GoldBank.Core.Modules.Payments.Domain.Entities;
using GoldBank.Core.Modules.Payments.Infrastructure.Persistence;
using GoldBank.Core.Modules.Transfers.Domain.Entities;
using GoldBank.Core.Modules.Transfers.Infrastructure.Persistence;
using GoldBank.Core.Modules.Admin.Domain.Entities;
using GoldBank.Core.Modules.Admin.Infrastructure.Persistence;
using GoldBank.Core.Modules.FraudDetection.Domain.Entities;
using GoldBank.Core.Modules.FraudDetection.Infrastructure.Persistence;
using GoldBank.Core.Modules.Loans.Domain.Entities;
using GoldBank.Core.Modules.Loans.Infrastructure.Persistence;
using GoldBank.Core.Modules.CardTransactions.Domain.Entities;
using GoldBank.Core.Modules.CardTransactions.Infrastructure.Persistence;
using GoldBank.Core.Modules.WhiteLabel.Domain.Entities;
using GoldBank.Core.Modules.WhiteLabel.Infrastructure.Persistence;
using GoldBank.Core.Modules.AI.Domain.Entities;
using GoldBank.Core.Modules.AI.Infrastructure.Persistence;
using GoldBank.Core.Modules.AssetCustody.Domain.Entities;
using GoldBank.Core.Modules.AssetCustody.Infrastructure.Persistence;
using GoldBank.Core.Modules.BranchCash.Domain.Entities;
using GoldBank.Core.Modules.BranchCash.Infrastructure.Persistence;
using GoldBank.Core.Modules.Customers.Domain.Entities;
using GoldBank.Core.Modules.Customers.Infrastructure.Persistence;
using GoldBank.Core.Modules.Ekub.Domain.Entities;
using GoldBank.Core.Modules.Ekub.Infrastructure.Persistence;
using GoldBank.SharedKernel.Domain;
using GoldBank.SharedKernel.MultiTenancy;

namespace GoldBank.Core.Common.Persistence;

public class GoldBankDbContext : DbContext
{
    private readonly string _tenantSchema;

    public GoldBankDbContext(DbContextOptions<GoldBankDbContext> options, ITenantProvider tenantProvider)
        : base(options)
    {
    ...
    public GoldBankDbContext(DbContextOptions<GoldBankDbContext> options, string tenantSchema)
        : base(options)
    {
    ...
    // Ekub module (group savings + lending product)
    public DbSet<EkubGroup> EkubGroups => Set<EkubGroup>();
    public DbSet<EkubMembership> EkubMemberships => Set<EkubMembership>();
    public DbSet<EkubInvitation> EkubInvitations => Set<EkubInvitation>();
    public DbSet<EkubContribution> EkubContributions => Set<EkubContribution>();
    public DbSet<EkubFee> EkubFees => Set<EkubFee>();
    public DbSet<EkubLoan> EkubLoans => Set<EkubLoan>();
    public DbSet<EkubLoanVote> EkubLoanVotes => Set<EkubLoanVote>();
    public DbSet<EkubLoanRepayment> EkubLoanRepayments => Set<EkubLoanRepayment>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Customers module (person aggregate; accounts FK to this)
        modelBuilder.ApplyConfiguration(new CustomerEntityConfiguration());

        // Ekub module (group savings + lending product)
        modelBuilder.ApplyConfiguration(new EkubGroupEntityConfiguration());
        modelBuilder.ApplyConfiguration(new EkubMembershipEntityConfiguration());
        modelBuilder.ApplyConfiguration(new EkubInvitationEntityConfiguration());
        modelBuilder.ApplyConfiguration(new EkubContributionEntityConfiguration());
        modelBuilder.ApplyConfiguration(new EkubFeeEntityConfiguration());
        modelBuilder.ApplyConfiguration(new EkubLoanEntityConfiguration());
        modelBuilder.ApplyConfiguration(new EkubLoanVoteEntityConfiguration());
        modelBuilder.ApplyConfiguration(new EkubLoanRepaymentEntityConfiguration());
