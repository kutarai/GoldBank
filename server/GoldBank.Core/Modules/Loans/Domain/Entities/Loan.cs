...
namespace GoldBank.Core.Modules.Loans.Domain.Entities;
...
public sealed class Loan : AggregateRoot
{
    ...
    /// <summary>
    /// IDs of registered assets pledged as collateral for this loan, persisted as JSON.
    /// Empty list = unsecured loan.
    /// </summary>
    public List<Guid> CollateralAssetIds { get; set; } = [];
