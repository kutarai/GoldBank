using Grpc.Core;
using GoldBank.Core.Modules.BillPay.Application.Commands;
using GoldBank.Core.Modules.BillPay.Application.Handlers;
using GoldBank.Protos.BillPay;
...
namespace GoldBank.Core.Modules.BillPay.Grpc;
