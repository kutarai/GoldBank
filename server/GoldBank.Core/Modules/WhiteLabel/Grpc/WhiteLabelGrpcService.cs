...
using GoldBank.Core.Modules.WhiteLabel.Application.Commands;
using GoldBank.Core.Modules.WhiteLabel.Application.Handlers;
using GoldBank.Core.Modules.WhiteLabel.Domain.Entities;
using GoldBank.Protos.WhiteLabel;

namespace GoldBank.Core.Modules.WhiteLabel.Grpc;
