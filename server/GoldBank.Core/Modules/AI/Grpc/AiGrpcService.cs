...
using GoldBank.Core.Modules.AI.Application.Handlers;
using GoldBank.Core.Modules.AI.Infrastructure.Services;
using GoldBank.Protos.AI;
using ProtoIdDocumentFields = GoldBank.Protos.AI.IdDocumentFields;
using ProtoPayslipFields = GoldBank.Protos.AI.PayslipDocumentFields;
using ProtoProofOfAddressFields = GoldBank.Protos.AI.ProofOfAddressDocumentFields;
using ProtoChequeFields = GoldBank.Protos.AI.ChequeDocumentFields;
using ProtoBillFields = GoldBank.Protos.AI.BillDocumentFields;
using ProtoReceiptFields = GoldBank.Protos.AI.ReceiptDocumentFields;
using GoldBank.SharedKernel.MultiTenancy;

namespace GoldBank.Core.Modules.AI.Grpc;
