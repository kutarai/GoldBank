...
namespace UniBank.SharedKernel.Logging;

/// <summary>
/// Extension methods for configuring Serilog across all UniBank services.
...
public static class SerilogExtensions
{
    ...
    /// Logical service name (e.g. "UniBank.Gateway"). Used as the Elasticsearch
        ...
        return hostBuilder.UseSerilog((context, services, loggerConfiguration) =>
        {
            ...
            loggerConfiguration
                ...
                .WriteTo.Elasticsearch(new ElasticsearchSinkOptions(new Uri(elasticUri))
                {
                    ...
                    IndexFormat = $"unibank-logs-{serviceName.ToLowerInvariant().Replace(".", "-")}-{{0:yyyy.MM.dd}}",
                    NumberOfShards = 1,
                    NumberOfReplicas = 0,
