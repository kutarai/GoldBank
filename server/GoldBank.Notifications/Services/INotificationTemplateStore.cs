...
public sealed class InMemoryNotificationTemplateStore : INotificationTemplateStore
{
    ...
    [
        ...
        new NotificationTemplate
        {
            ...
            BodyTemplate = "GoldBank: {transaction_type} {amount} {counterparty_name}. Bal: {balance}. Ref: {reference}",
        ...
        new NotificationTemplate
        {
            EventType = "TransactionFailed",
            Channel = NotificationChannel.Sms,
            BodyTemplate = "GoldBank: Transaction {amount} failed. {failure_reason}. Ref: {reference}",
            Variables = ["amount", "failure_reason", "reference"]
        },
        ...
        new NotificationTemplate
        {
            ...
            Channel = NotificationChannel.Sms,
            BodyTemplate = "Welcome to GoldBank, {name}! Your account is ready. Complete KYC to unlock all features.",
            Variables = ["name"]
        },
        ...
        new NotificationTemplate
        {
            ...
            Channel = NotificationChannel.Push,
            TitleTemplate = "Welcome to GoldBank",
        ...
        new NotificationTemplate
        {
            EventType = "AccountCreated",
            Channel = NotificationChannel.Sms,
            BodyTemplate = "Welcome to GoldBank! Your {account_type} account is ready. Complete KYC to unlock all features.",
            Variables = ["account_type"]
        },
        ...
        new NotificationTemplate
        {
            EventType = "KYCApproved",
            Channel = NotificationChannel.Sms,
            BodyTemplate = "GoldBank: KYC approved. {kyc_level} access granted.",
            Variables = ["kyc_level"]
        },
        ...
        new NotificationTemplate
        {
            EventType = "KYCRejected",
            Channel = NotificationChannel.Sms,
            BodyTemplate = "GoldBank: Your verification was not accepted. Please resubmit in the app.",
            Variables = ["rejection_reason"]
        },
        ...
        new NotificationTemplate
        {
            EventType = "FraudAlertRaised",
            Channel = NotificationChannel.Sms,
            BodyTemplate = "ALERT: Unusual activity on your GoldBank account. {description}. Call support immediately if not you.",
            Variables = ["description"],
            Priority = NotificationPriority.Critical
        },
        ...
        new NotificationTemplate
        {
            EventType = "LowFloatAlert",
            Channel = NotificationChannel.Sms,
            BodyTemplate = "GoldBank Agent: Low float ({current_float}/{float_limit}). Please top up.",
            Variables = ["current_float", "float_limit"]
        }
    ];
