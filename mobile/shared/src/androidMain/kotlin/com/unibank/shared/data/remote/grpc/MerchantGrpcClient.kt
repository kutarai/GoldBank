...
import com.unibank.shared.data.mapper.MerchantMapper
import com.unibank.shared.domain.model.BusinessDocumentUploadResult
import com.unibank.shared.domain.model.MerchantAddress
import com.unibank.shared.domain.model.MerchantCommissionReport
import com.unibank.shared.domain.model.MerchantProfile
import com.unibank.shared.domain.model.MerchantRegistrationResult
import com.unibank.shared.domain.model.MerchantStatusInfo
import com.unibank.shared.domain.model.MerchantTransaction
import com.unibank.shared.domain.model.Settlement
import com.unibank.shared.domain.model.SettlementDetail
import io.grpc.ManagedChannel
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.flow
import kotlinx.coroutines.flow.map
import unibank.v1.merchants.MerchantServiceGrpcKt
import unibank.v1.merchants.MerchantServiceOuterClass as Proto
...
class MerchantGrpcClient(channel: ManagedChannel) {
    ...
    fun getTransactions(
        ...
        val request = Proto.MerchantTransactionsRequest.newBuilder()
            .setMerchantId(merchantId)
            .setDateRange(
                unibank.v1.common.Common.DateRange.newBuilder()
