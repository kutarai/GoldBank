...
import com.goldbank.shared.domain.model.DepositReceiptOcr
import com.goldbank.shared.domain.model.ChequeFields
import com.goldbank.shared.domain.model.DisputeTriage
import com.goldbank.shared.domain.model.DocumentFields
import com.goldbank.shared.domain.model.FraudExplanation
import com.goldbank.shared.domain.model.KycVerificationResult
import com.goldbank.shared.domain.model.LoanDocVerification
import com.goldbank.shared.domain.model.ModelStatus
import com.goldbank.shared.domain.model.ReceiptFields
import com.goldbank.shared.domain.model.SpendingInsightsResult
import com.goldbank.shared.domain.util.Result
import io.grpc.ManagedChannel
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.map
import goldbank.v1.ai.AIServiceGrpcKt.AIServiceCoroutineStub
import goldbank.v1.ai.AiService
import goldbank.v1.ai.AiService.DocumentType
...
class AiGrpcClient(channel: ManagedChannel) {
    ...
    fun chat(
        accountId: String,
        message: String,
        history: List<com.goldbank.shared.domain.model.ChatMessage>,
    ): Flow<com.goldbank.shared.domain.model.ChatResponse> {
    ...
    suspend fun checkLoanEligibility(
        ...
        tenureMonths: Int,
        purpose: String,
    ): Result<com.goldbank.shared.domain.model.LoanEligibility> = grpcCall {
