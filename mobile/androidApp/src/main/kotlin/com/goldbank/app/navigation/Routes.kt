...
sealed interface Route {
    ...
    // Ekub
    @Serializable data object EkubGroupList : Route
    @Serializable data object EkubCreateGroup : Route
    @Serializable data object EkubInvitations : Route
    @Serializable data class EkubGroupDetail(val groupId: String) : Route
}
